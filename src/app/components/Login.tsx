...
interface LoginProps {
  ...
  onSignup?: (fullName: string, email: string, pass: string) => Promise<string>;
  onResetPassword?: (email: string) => Promise<void>;
  onVerifyOtp?: (email: string, otp: string) => Promise<void>;
  onResendOtp?: (email: string) => Promise<void>;
}

export function Login({ onLogin, onSignup, onResetPassword, onVerifyOtp, onResendOtp }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        const verifyEmail = await onSignup(fullName, email, password);
