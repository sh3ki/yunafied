...
export interface AssessmentAssignment { id: string; assessmentId: string; pairedAssessmentId?: string | null; studentId: string; studentName: string; teacherId: string; teacherName: string; subject: string; gradeLevel: string; assessmentType: AssessmentType; title: string; dueAt: string | null; attemptStatus: "not_started" | "in_progress" | "submitted"; score: number | null; improvement: number | null; }
